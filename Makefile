export TRANSIFEX_RESOURCE = frontend-app-program-manager
...
pull_translations:
	...
	$(intl_imports) frontend-component-header frontend-component-footer paragon frontend-app-program-manager
endif
